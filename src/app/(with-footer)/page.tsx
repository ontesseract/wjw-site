    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-lg mb-4">
                  Immerse yourself among the crowd as Jesus raises Lazarus from
                  the tomb. Feel the spray of the sea as He commands the waves
                  to be still. Walk beside Him through the streets of Jerusalem
                  as He carries the cross. Watch the storm clouds break as He
                  walks across the water.
                </p>
                <p className="text-lg">
                  At Where Jesus Walked, these powerful moments will surround
                  you on 360º screens with breathtaking visuals and
                  awe-inspiring sound. In this 70-minute biblical production,
                  you&apos;ll encounter the teachings, miracles, and sacrifice
                  of Christ in a way no other Missouri attraction can offer.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-muted text-secondary-foreground">
          <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
            <h2 className="text-3xl font-bold mb-8 text-center">
              Why &ldquo;Where Jesus Walked&rdquo; is Branson&apos;s Must-See
              Christian Theater Immersive Experience
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4 p-6 border border-border rounded-lg bg-background">
                ...
                <p>
                  Surrounded by 360° visuals and sound, you don&apos;t just
                  watch the Gospel story... you step inside it.
                </p>
              </div>
              <div className="space-y-4 p-6 border border-border rounded-lg bg-background">
                <h3 className="text-xl font-semibold">Faith at the Center</h3>
                <p>
                  Every moment of this 70-minute biblical production is rooted
                  in scripture, making it Branson&apos;s most meaningful
                  faith-based attraction.
                </p>
              </div>
              <div className="space-y-4 p-6 border border-border rounded-lg bg-background">
                <h3 className="text-xl font-semibold">Accessible to All</h3>
                <p>
                  Designed for families, tour groups, and believers of all ages.
                  A highlight of any Branson itinerary.
                </p>
              </div>
              <div className="space-y-4 p-6 border border-border rounded-lg bg-background">
                <h3 className="text-xl font-semibold">
                ...
                <p>
                  More than a show - it&apos;s an encounter with Christ&apos;s
                  miracles, sacrifice, and redemption.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4 text-lg">
                  ...
                  <li className="flex items-center gap-3">
                    <span className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></span>
                    <span>
                      Tickets Made Easy &mdash; online booking in minutes.
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></span>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-lg">
                    Explore Branson&apos;s best family shows, perfect for kids,
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-lg">
                    From biblical theater to live gospel music, Branson offers
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
            ...
            <div className="text-center mt-12">
              <p className="mb-6 text-lg">
                Still have questions? View our complete FAQ or contact us!
              </p>
